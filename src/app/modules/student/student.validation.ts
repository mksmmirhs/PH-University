...
const userNameValidationSchema = z.object({
  ...
  middleName: z.string({ invalid_type_error: 'Middle name must not be empty' }).optional(),
...
const updateUserNameValidationSchema = z.object({
  ...
  middleName: z.string().min(1, { message: 'Middle name must not be empty' }).optional(),
  lastName: z.string().min(1, { message: 'Last name must not be empty' }).optional(),
});

const updateGuardianValidationSchema = z.object({
  fatherName: z.string().min(1, { message: 'Father name must not be empty' }).optional(),
  fatherOccupation: z
    .string()
  ...
  fatherContactNo: z
    ...
    .optional(),
  motherName: z.string().min(1, { message: 'Mother name must not be empty' }).optional(),
  motherOccupation: z
    .string()
