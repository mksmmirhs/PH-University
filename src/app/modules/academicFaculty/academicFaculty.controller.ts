...
const findAllAcademicFaculty = catchAsync(async (req: Request, res: Response) => {
...
const findSingleAcademicFacultyById = catchAsync(async (req: Request, res: Response) => {
  const { facultyId } = req.params;
  const result = await AcademicFacultyService.findSingleAcademicFacultyById(facultyId);
  sendResponse(res, {
    success: true,
    statusCode: httpStatus.OK,
...
const updateAcademicFacultyIntoDB = catchAsync(async (req: Request, res: Response) => {
  const { facultyId } = req.params;
  const payload = req.body;
  const result = await AcademicFacultyService.updateAcademicFacultyIntoDB(facultyId, payload);
  sendResponse(res, {
    success: true,
    statusCode: httpStatus.OK,
